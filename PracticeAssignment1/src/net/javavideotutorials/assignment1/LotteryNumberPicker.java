...
public class LotteryNumberPicker 
{
  ...
  { 
	  Scanner in = new Scanner(System.in);
	  Set<Integer> userInputLottery;
	  try{
		  
		 
		  userInputLottery = new HashSet<Integer>();
		  
		  for(int i=0; i<6; i++){
			  System.out.print("Please enter lottery number:");
			  userInputLottery.add(in.nextInt());
			  // validate here 
		  	}
	  	}
	  finally{
